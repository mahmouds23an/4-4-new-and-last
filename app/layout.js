// app/layout.js — root layout: fonts, providers (Language + Cart), Header, Footer
...
export const metadata = {
  ...
  keywords: ["4x4", "off-road", "overlanding", "suspension", "lighting", "recovery", "Saudi Arabia"],
  openGraph: { type: "website", locale: "en_US", siteName: "4x4 Center" },
  twitter: { card: "summary_large_image", site: "@4x4center" },
